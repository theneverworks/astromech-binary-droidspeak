...
You could/should adjust the filters that remove the keyword(s) from the payload before it is sent to Deep Speech. This helps with accuracy but isn’t required.
